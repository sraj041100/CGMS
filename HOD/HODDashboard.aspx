<%@ Page Title="" Language="C#" MasterPageFile="~/HOD/HOD.master" AutoEventWireup="true" CodeFile="HODDashboard.aspx.cs" Inherits="HOD_HODDashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CGMS | HOD Dashboard</title>
</asp:Content>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="HODDashboard.aspx">Home</a></li>
