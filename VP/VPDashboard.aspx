<%@ Page Title="" Language="C#" MasterPageFile="~/VP/VP.master" AutoEventWireup="true" CodeFile="VPDashboard.aspx.cs" Inherits="VP_VPDashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CGMS | VICE-PRINCIPAL Dashboard</title>
</asp:Content>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="VPDashboard.aspx">Home</a></li>
