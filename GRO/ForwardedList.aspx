<%@ Page Title="" Language="C#" MasterPageFile="~/GRO/GROMasterPage.master" AutoEventWireup="true" CodeFile="ForwardedList.aspx.cs" Inherits="GRO_ForwardedList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CGMS | Grievance Forwarded List</title>
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Forwarded List</h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Forwarded</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body" style="height: 500px; overflow: auto;">
                                ...
                                <asp:GridView ID="grdgrievancedetails" runat="server" CssClass="w-100" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="true" PagerSettings-Position="Bottom" PageSize="20" OnPageIndexChanging="grdgrievancedetails_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ForwardedTo" HeaderText="Forwarded To" HeaderStyle-CssClass="m-1 p-1 text-md-start text-center" ItemStyle-CssClass="m-1 p-1 text-md-start text-center"></asp:BoundField>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Forward To" HeaderStyle-CssClass="m-1 p-1 text-center text-md-start" ItemStyle-CssClass="m-1 p-1 text-center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("id") %>' CommandName="view" runat="server" class=" btn btn-outline-secondary btn-xs">View</asp:LinkButton>                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                    </Columns>
