<%@ Page Title="" Language="C#" MasterPageFile="~/GRO/GROMasterPage.master" AutoEventWireup="true" CodeFile="GRODashboard.aspx.cs" Inherits="GRO_GRODashboard" Async="true" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>CGMS | GRO Dashboard</title>
</asp:Content>
                            ...
                            <asp:GridView ID="grdgrievancedetails" runat="server" CssClass="w-100" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="true" PagerSettings-Position="Bottom" PageSize="20" OnRowCommand="grdgrievancedetails_RowCommand" OnPageIndexChanging="grdgrievancedetails_PageIndexChanging" EmptyDataText="No Data Found">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Forward To" HeaderStyle-CssClass="m-1 p-1 text-center text-md-start" ItemStyle-CssClass="m-1 p-1 text-center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("id") %>' CommandName="ed" runat="server" class=" btn btn-outline-secondary btn-xs">Forward &nbsp;&nbsp;&nbsp;<i class="fas fa-angle-right"></i></asp:LinkButton>
                                           <%-- <asp:LinkButton ID="btnview" CommandArgument='<%#Eval("id") %>' CommandName="view" runat="server" class=" btn btn-outline-secondary btn-xs" Visible="false">View &nbsp;&nbsp;&nbsp;<i class="fas fa-angle-right"></i></asp:LinkButton>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
